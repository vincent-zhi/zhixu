...
<style>
  ...
  h2 { font-size: 20px; margin-top: 28px; border-left: 4px solid #b8956b; padding-left: 12px; }
  h3 { font-size: 17px; margin-top: 24px; }
  h4, h5, h6 { font-size: 15px; margin-top: 20px; }
  p { margin: 8px 0; text-indent: 2em; }
  li { margin: 4px 0; list-style: disc inside; }
  blockquote { border-left: 3px solid #94a3b8; padding-left: 16px; margin: 12px 0; color: #475569; font-style: italic; }
  pre.formula { background: #f8f6f1; padding: 12px; border-radius: 6px; font-family: "JetBrains Mono", monospace; font-size: 13px; }
  .color-green { border-left: 3px solid #16a34a; padding-left: 8px; }
  .color-yellow { border-left: 3px solid #d97706; padding-left: 8px; }
  .color-gray { border-left: 3px solid #94a3b8; padding-left: 8px; }
